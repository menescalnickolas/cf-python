class Height(object):
    ...
    def __sub__(self, other):
        ...
        #Subtracting them
        subtraction_height_inches = height_A_inches - height_B_inches

        # Getting the output in feet
        output_feet = subtraction_height_inches // 12

        # Getting the output in inches
        output_inches = subtraction_height_inches - (output_feet * 12)
...
print("Height subtraction: ", height_sub)